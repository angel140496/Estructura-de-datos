...
namespace INVENTARIO
{
    public partial class Form1 : Form
    {
        ...
        private void cmdListarProd_Click_1(object sender, EventArgs e)
        {
            txtInfo.Clear();
        ...
        {
            product p1;
            if (txtCod.Text == "" || txtNombre.Text == "" || txtCant.Text == "" || txtCost.Text == "" || txtposicion.Text=="")
            {
            ...
            else
            {
                ...
                _posicion = Convert.ToInt32(txtposicion.Text);

                p1 = new product(_codigo, _nombre, _cantidad, _costo, _posicion);
                In1.mAgregar(p1);
